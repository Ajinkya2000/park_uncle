        ...
        <div>
            <form onSubmit={onFormSubmit} className="form">
                <div className="field">
                    ...
                    <label for="" className="label has-text-grey">Name</label>
                    <div className="control has-icons-left">
                        <input
                            ...
                            onChange={event => setFormData({ ...formData, name: event.target.name })}
                ...
                <div className="field mt-5">
                    <p className="control">
                        <button type="submit" className={loadingUser ? 'is-loading button is-large is-fullwidth register-button' : 'button is-large is-fullwidth register-button'}>
